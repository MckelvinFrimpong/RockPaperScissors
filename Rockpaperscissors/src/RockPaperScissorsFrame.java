...
import java.awt.event.ActionEvent;
    ...
    public class RockPaperScissorsFrame extends JFrame {
        ...
        private void CreateTitlePnl(){
            ...
            title.setFont(new Font("Oswald", Font.BOLD, 50));
        ...
        private void CreateChoicePnl(){
            ...
            rockIco = new ImageIcon("rockIcon Small 2.png");
            ...
            paperIco = new ImageIcon("PaperIcon Small.png");
            ...
            paperBtn.addActionListener((ActionEvent ae) ->{
                ...
                aiChoice = rnd.nextInt(3) + 1;
                if(aiChoice == 1){
                    results.append("Paper beats Rock. You Win!\n\n");
                    usrWinCnt = usrWinCnt + 1;
                    usrWinField.setText(String.valueOf(usrWinCnt));
                }
                if(aiChoice == 2){
            ...
            scissorIco = new ImageIcon("ScissorsIcon Small.png");
            ...
            scissorBtn.setFont(new Font("Oswald", Font.BOLD, 15));
            ...
            quitBtn.setFont(new Font("Oswald", Font.BOLD, 15));
        ...
        private void CreateWinCntPnl(){
            ...
            userIco = new ImageIcon("userIcon Small.png");
            ...
            aiIco = new ImageIcon("AiIcon Small.png");
